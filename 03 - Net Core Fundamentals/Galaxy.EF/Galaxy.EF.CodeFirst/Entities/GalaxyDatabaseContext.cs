...
{
    public partial class GalaxyDatabaseContext : DbContext
    {
        public GalaxyDatabaseContext()
        {
        }

        public GalaxyDatabaseContext(DbContextOptions<GalaxyDatabaseContext> options)
            : base(options)
        {
        }
