    ...
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var query = from p in _context.Posts
                        join ua in _context.Usuarios on p.UsuarioIdActualizacion equals ua.UsuarioId
                            //into uaJoin
                            //from uaLeft in uaJoin.DefaultIfEmpty()
                        join uc in _context.Usuarios on p.UsuarioIdCreacion equals uc.UsuarioId
                        ...
                        select new PostViewModel { 
                            ...
                            UsuarioIdCreacion = p.UsuarioIdActualizacion,
                            UsuarioIdPropietario = p.UsuarioIdPropietario,
                            UsuarioActualizacion = new UsuarioViewModel
                            {
                                UsuarioId = ua.UsuarioId,
                                Nombre = ua.Nombre,
                                ApellidoPaterno = ua.ApellidoPaterno,
                                ApellidoMaterno = ua.ApellidoMaterno
                            },
                            UsuarioCreacion = new UsuarioViewModel
                            {
                                UsuarioId = uc.UsuarioId,
                                Nombre = uc.Nombre,
                                ApellidoPaterno = uc.ApellidoPaterno,
                                ApellidoMaterno = uc.ApellidoMaterno
                            },
                            UsuarioPropietario = new UsuarioViewModel
                            {
                                UsuarioId = up.UsuarioId,
                                Nombre = up.Nombre,
                                ApellidoPaterno = up.ApellidoPaterno,
                                ApellidoMaterno = up.ApellidoMaterno
                            },

                        };

            List<PostViewModel> posts = query.ToList();
